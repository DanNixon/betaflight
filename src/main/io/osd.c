...
void pgResetFn_osdConfig(osdConfig_t *osdConfig)
{
    ...
    OSD_INIT(osdConfig, OSD_RSSI_VALUE       ,  -5,  1, OSD_FLAG_ORIGIN_N  | OSD_FLAG_VISIBLE);
    OSD_INIT(osdConfig, OSD_MAIN_BATT_VOLTAGE,   0,  1, OSD_FLAG_ORIGIN_N  | OSD_FLAG_VISIBLE);
    OSD_INIT(osdConfig, OSD_AVG_CELL_VOLTAGE ,   0,  2, OSD_FLAG_ORIGIN_N  | OSD_FLAG_VISIBLE);
    ...
    OSD_INIT(osdConfig, OSD_GPS_SPEED        ,  -6, -1, OSD_FLAG_ORIGIN_E  | OSD_FLAG_VISIBLE);
    ...
    OSD_INIT(osdConfig, OSD_GPS_SATS         ,  -6, -2, OSD_FLAG_ORIGIN_E  | OSD_FLAG_VISIBLE);

    OSD_INIT(osdConfig, OSD_VTX_CHANNEL      ,  -5, -1, OSD_FLAG_ORIGIN_SE | OSD_FLAG_VISIBLE);
    OSD_INIT(osdConfig, OSD_PIDRATE_PROFILE  ,  -5,  0, OSD_FLAG_ORIGIN_SE | OSD_FLAG_VISIBLE);

    OSD_INIT(osdConfig, OSD_FLYMODE          ,  -1, -1, OSD_FLAG_ORIGIN_S  | OSD_FLAG_VISIBLE);
    ...
    OSD_INIT(osdConfig, OSD_YAW_PIDS         ,   7, -0, OSD_FLAG_ORIGIN_SW | OSD_FLAG_VISIBLE);
    OSD_INIT(osdConfig, OSD_POWER            ,   1, -5, OSD_FLAG_ORIGIN_SW | OSD_FLAG_VISIBLE);
    ...
    OSD_INIT(osdConfig, OSD_ESC_TMP          ,   1, -4, OSD_FLAG_ORIGIN_W  | OSD_FLAG_VISIBLE);
    OSD_INIT(osdConfig, OSD_ESC_RPM          ,   1, -3, OSD_FLAG_ORIGIN_W  | OSD_FLAG_VISIBLE);

    OSD_INIT(osdConfig, OSD_WARNINGS         ,  -5,  3, OSD_FLAG_ORIGIN_C  | OSD_FLAG_VISIBLE);
    OSD_INIT(osdConfig, OSD_HOME_DIST        ,  -6, -4, OSD_FLAG_ORIGIN_C  | OSD_FLAG_VISIBLE);
    OSD_INIT(osdConfig, OSD_HOME_DIR         ,  -6, -3, OSD_FLAG_ORIGIN_C  | OSD_FLAG_VISIBLE);
    OSD_INIT(osdConfig, OSD_COMPASS_BAR      ,  -4,  1, OSD_FLAG_ORIGIN_C  | OSD_FLAG_VISIBLE);
    OSD_INIT(osdConfig, OSD_DISARMED         ,  -4, -3, OSD_FLAG_ORIGIN_C  | OSD_FLAG_VISIBLE);
